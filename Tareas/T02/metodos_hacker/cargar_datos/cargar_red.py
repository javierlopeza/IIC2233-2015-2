import datetime
from clases.Conexion_Puerto_Red import Red
from clases.clasificar_conexiones import clasificar_conexiones
from metodos_hacker.cargar_datos.writefile_red import writefile_red
