class Persona:
    def __init__(self, nombre="", usuario="", clave="", alumno="", idolos=[], cursos_aprobados=[], **kwargs):
        self.nombre = nombre
...
class Alumno(Persona):
    ...
    def __repr__(self):
        printear = "Nombre alumno: {}\nUsuario: {}\n".format(self.nombre, self.usuario)
        printear += "Clave: {}\nHorario de inscripcion: {}\n".format(self.clave, self.horario_inscripcion)
...
class Profesor(Persona):
    ...
    def __repr__(self):
        printear = "Nombre profesor: {}\nUsuario: {}\nClave: {}".format(self.nombre, self.usuario, self.clave)
        return printear
...
class Curso(Horario):
    def __init__(self, nombre="", sigla="", nrc=0, retiro="", eng="", aprobacion_especial="", profesor="",
                 lista_de_alumnos=[], seccion=0, campus="", creditos=0, evaluaciones=[], pre_requisitos=[],
                 equivalencias=[], ocupados=0, disponibles=0, ofrecidos=0, **kwargs):
        super().__init__(**kwargs)
        self.curso = nombre
        self.sigla = sigla
        self.nrc = nrc
