...
aud_inalambrico = Inalambrico(min_f=0, max_f=100, impedencia=150, int_max=200,
                              rango_max=45)  # Instancio un Audifono Inalambrico.
aud_bt = Bluetooth(min_f=0, max_f=100, impedencia=150, int_max=200, rango_max=50,
                   identificador=123)  # Instancio un Audifono Inalambrico Bluetooth.

audifono.escuchar(
    "Yellow Submarine")  # Reproduzco la cancion Yellow Submarine con el Audifono instanciado anteriormente.
aud_over.escuchar(
    "Bohemian Rapsody")  # Reproduzco la cancion Bohemian Rapsody con el Audifono OverHear instanciado anteriormente.
aud_inalambrico.escuchar(
    "We Will Rock You")  # Reproduzco la cancion We Will Rock You con el Audifono Inalambrico instanciado anteriormente.
aud_bt.escuchar(
    "Thriller")  # Reproduzco la cancion Thriller con el Audifono Inalambrico Bluetooth instanciado anteriormente.
...
reproductor.conectar_audifono(aud_inalambrico,
                              55)  # Intento fallido de conectar el Audifono Inalambrico al reproductor.
reproductor.conectar_audifono(aud_inalambrico,
                              20)  # Intento exitoso de conectar el Audifono Inalambrico al reproductor.
